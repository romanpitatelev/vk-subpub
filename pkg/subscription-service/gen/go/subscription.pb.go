...
const file_subscription_proto_rawDesc = "" +
	"\n" +
	"\x12subscription.proto\x12\x0fsubscription.v1\x1a\x1bgoogle/protobuf/empty.proto\"$\n" +
	...
	"\x05Event\x12\x12\n" +
	"\x04data\x18\x01 \x01(\tR\x04data2\x96\x01\n" +
	"\x06PubSub\x12H\n" +
	"\tSubscribe\x12!.subscription.v1.SubscribeRequest\x1a\x16.subscription.v1.Event0\x01\x12B\n" +
	"\aPublish\x12\x1f.subscription.v1.PublishRequest\x1a\x16.google.protobuf.EmptyB>Z<github.com/romanpitatelev/vk-subpub/pkg/subscription-serviceb\x06proto3"
...
var file_subscription_proto_goTypes = []any{
	...
	(*PublishRequest)(nil),   // 1: subscription.v1.PublishRequest
	(*Event)(nil),            // 2: subscription.v1.Event
	(*emptypb.Empty)(nil),    // 3: google.protobuf.Empty
}
var file_subscription_proto_depIdxs = []int32{
	0, // 0: subscription.v1.PubSub.Subscribe:input_type -> subscription.v1.SubscribeRequest
	1, // 1: subscription.v1.PubSub.Publish:input_type -> subscription.v1.PublishRequest
	2, // 2: subscription.v1.PubSub.Subscribe:output_type -> subscription.v1.Event
	3, // 3: subscription.v1.PubSub.Publish:output_type -> google.protobuf.Empty
