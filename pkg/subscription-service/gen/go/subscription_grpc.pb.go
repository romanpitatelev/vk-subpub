...
const (
	PubSub_Subscribe_FullMethodName = "/subscription.v1.PubSub/Subscribe"
	PubSub_Publish_FullMethodName   = "/subscription.v1.PubSub/Publish"
)
...
var PubSub_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "subscription.v1.PubSub",
